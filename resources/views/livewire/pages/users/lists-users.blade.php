<div>
    ...
    <div class="mx-auto max-w-7xl py-12 space-y-6">
        <h2 class="font-semibold text-2xl">Liste des agents</h2>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                ...
                <tr>
                    ...
                    <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Date de creation</th>
                ...
                <tbody class="divide-y divide-gray-200 text-center space-x-4">
                    @foreach($users as $user)
                        <tr wire:key="{{ $user->id }}">
                            ...
                            <td class="whitespace-nowrap px-4 py-4 text-gray-700">{{$user->created_at->diffForHumans()}}</td>
                            <td class="whitespace-nowrap px-4 py-4 text-gray-700">

                                <span class="{{ $user->is_admin ? 'bg-green-400 text-white px-2 py-1 rounded-full' :  'bg-blue-400 text-white px-2 py-1 rounded-full' }}">
